...
The **Gold Layer** serves as the business-level data representation, structured specifically to support analytical and reporting use cases. It utilizes a Star Schema architecture, consisting of **dimension tables** for descriptive attributes and **fact tables** for transactional business metrics.
...
**Purpose:** Provides information about the products, their hierarchy, and attributes.
** Columns:
...
**Purpose:** Stores transactional sales data linked to dimensions for analytical purposes.
** Columns

| Column Name | Data Type | Description |
| :--- | :--- | :--- |
| `order_number` | **NVARCHAR(50)** | A unique alphanumeric identifier for each sales order (e.g., 'SO54496'). |
| `product_key` | **INT** | Surrogate key linking the order to the `dim_products` table. |
